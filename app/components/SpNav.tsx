    ...
    <>
      ...
      >
        <ul>
          ...
          <li className="my-5"><Link href="#" className="hover:underline">Live</Link></li>
          <li className="my-5"><Link href="#" className="hover:underline">Discography</Link></li>
          <li className="my-5"><Link href="#" className="hover:underline">
            <span className="flex items-center">
              Shop <BsArrowUpRight className="ml-0.5" />
            </span></Link></li>
          <li className="my-5"><Link href="#" className="hover:underline">Media</Link></li>
          <li className="my-5"><Link href="#" className="hover:underline">Contact</Link></li>
        </ul>
      </nav>
    </>
  );
