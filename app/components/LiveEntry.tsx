...
const LiveEntry: React.FC<ContentProps> = ({ 
  title, venue, date, time, charge, performers, description, setlistCollection, encore, imagesCollection
 }) => {
      ...
      <div className="md:w-5/6 md:pl-4">
        ...
        {!venue.url ? (
          ...
          <p className="text-muted-foreground mb-4 underline">
            <a href={`${venue.url}`} rel="noreferrer" target="_blank">{venue.name}</a>
          </p>
          )
        }
